...
context-dependent drug. Its primary therapeutic target is BCR-ABL, but
it hits eight kinase targets (ABL1, KIT, PDGFRA/B, DDR1, RET, NTRK1,
CSF1R). Across the LINCS panel, its signatures rotate 88$^\circ$ on
...
$p = 1.1 \times 10^{-16}$) and in the expected direction, but fell below
our pre-registered effect-size threshold of $|\rho| > 0.3$.
...
consensus. Binarizing held-out outcomes as ``consistent'' (cosine $> 0.3$)
versus ``inconsistent,'' LOO instability achieved AUROC $= 0.986$.
